...
int8_t STORAGE_Read_HS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
  ...
  UNUSED(blk_len);
	  ...
	  W25Qxx_ReadData(&w25qxx, blk_addr * STORAGE_BLK_SIZ, blk_len * STORAGE_BLK_SIZ, buf);
...
int8_t STORAGE_Write_HS(uint8_t lun, uint8_t *buf, uint32_t blk_addr, uint16_t blk_len)
{
  ...
  UNUSED(blk_len);
	  ...
	  W25Qxx_WriteData(&w25qxx,blk_addr * STORAGE_BLK_SIZ, blk_len * STORAGE_BLK_SIZ, buf);
