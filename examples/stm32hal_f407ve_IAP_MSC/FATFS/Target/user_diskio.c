...
)
{
  /* USER CODE BEGIN READ */
	...
	UINT i;
	for (i = 0; i < count; i++)
	W25Qxx_ReadData(&w25qxx,( sector  + i )* SECTOR_SIZE, SECTOR_SIZE,buff+SECTOR_SIZE*i );
...
)
{
  ...
  for (i = 0; i < count; i++)
  {
    W25Qxx_WriteData(&w25qxx, ( sector  + i )* SECTOR_SIZE, SECTOR_SIZE,buff+SECTOR_SIZE*i  );
  }
