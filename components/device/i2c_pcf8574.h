...
err_t PCF8574_ReadPins(i2c_pcf8574_t* pHandle, uint8_t u8PinMask, __OUT pin_level_e* peLevel);
...
err_t PCF8574_ReadKey(i2c_pcf8574_t* pHandle, pcf8574_pin_e ePin, __OUT bool* pbIsPressed);
err_t PCF8574_ScanMatrixkey4x4(i2c_pcf8574_t* pHandle, __OUT uint8_t* pu8KeyIndex);
