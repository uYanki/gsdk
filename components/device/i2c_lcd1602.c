...
static err_t LCD1602_WriteByte(i2c_lcd1602_t* pHandle, uint8_t u8Data, uint8_t u8Mode /* rs = 0x00:cmd, 0x01:data */)
{
    uint8_t au8Buff[4];
...
static inline err_t LCD1602_WriteCmd(i2c_lcd1602_t* pHandle, uint8_t u8Data)
{
    return LCD1602_WriteByte(pHandle, u8Data, 0x00);
}

static inline err_t LCD1602_WriteData(i2c_lcd1602_t* pHandle, uint8_t u8Data)
{
...
err_t LCD1602_BacklightOn(i2c_lcd1602_t* pHandle)
{
...
err_t LCD1602_BacklightOff(i2c_lcd1602_t* pHandle)
{
...
err_t LCD1602_ShowChar(i2c_lcd1602_t* pHandle, const char ch)
{
    return LCD1602_WriteData(pHandle, ch);
}

err_t LCD1602_ShowString(i2c_lcd1602_t* pHandle, const char* str)
{
    while (*str)
    {
...
err_t LCD1602_SetCursor(i2c_lcd1602_t* pHandle, uint8_t u8Col, uint8_t u8Row)
{
...
// 显示字符串（带自动换行）
err_t LCD1602_ShowStringWrap(i2c_lcd1602_t* pHandle, uint8_t u8Col, uint8_t u8Row, const char* str)
{
    // LCD1602_Set cursor
...
err_t LCD1602_DisplayOn(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl |= LCD1602_DISPLAYON);
}

err_t LCD1602_DisplayOff(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl &= ~LCD1602_DISPLAYON);
}

// Turns the underline cursor on/off
err_t LCD1602_CursorOn(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl |= LCD1602_CURSORON);
}

err_t LCD1602_CursorOff(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl &= ~LCD1602_CURSORON);
}

// Turn on and off the blinking cursor
err_t LCD1602_BlinkOn(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl |= LCD1602_BLINKON);
}

err_t LCD1602_BlinkOff(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispCtrl &= ~LCD1602_BLINKON);
}

// This is for text that flows Left to Right
err_t LCD1602_LeftToRight(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispMode |= LCD1602_ENTRYLEFT);
}

// This is for text that flows Right to Left
err_t LCD1602_RightToLeft(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispMode &= ~LCD1602_ENTRYLEFT);
}

// This will 'right justify' text from the cursor 每写1个字符，屏幕左移1次，但光标位置不变, 以实现内容右对齐光标
err_t LCD1602_AutoScrollOn(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispMode |= LCD1602_ENTRYSHIFTINCREMENT);
}

// This will 'left justify' text from the cursor
err_t LCD1602_AutoScrollOff(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, pHandle->_u8DispMode &= ~LCD1602_ENTRYSHIFTINCREMENT);
}

// Allows us to fill the first 8 CGRAM locations with custom characters 显示自定义字符
err_t LCD1602_CreateChar(i2c_lcd1602_t* pHandle, uint8_t u8Location /*0~7*/, uint8_t u8CharMap[])
{
...
err_t LCD1602_ScrollLeft(i2c_lcd1602_t* pHandle)
{
    return LCD1602_WriteCmd(pHandle, LCD1602_CURSORSHIFT | LCD1602_DISPLAYMOVE | LCD1602_MOVELEFT);
}

err_t LCD1602_ScrollRight(i2c_lcd1602_t* pHandle)
{
