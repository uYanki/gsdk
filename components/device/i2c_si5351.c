...
static inline err_t SI5351_WriteByte(i2c_si5351_t* pHandle, uint8_t u8MemAddr, uint8_t u8Data);
static inline err_t SI5351_WriteBlock(i2c_si5351_t* pHandle, uint8_t u8MemAddr, const uint8_t* cpu8Data, uint8_t u8Size);
static inline err_t SI5351_ReadByte(i2c_si5351_t* pHandle, uint8_t u8MemAddr, uint8_t* pu8Data);
 ...
 */
err_t SI5351_SetClockBuilderData(i2c_si5351_t* pHandle)
{
    uint16_t i = 0;
 ...
 */
err_t SI5351_SetupPLLInt(i2c_si5351_t* pHandle, si5351_pll_e ePll, uint8_t u8Mult)
{
 ...
 */
err_t SI5351_SetupPLL(i2c_si5351_t* pHandle, si5351_pll_e ePll, uint8_t u8Multiplier, uint32_t u32Numerator, uint32_t u32Denominator)
{
 ...
 */
err_t SI5351_SetupMultisynthInt(i2c_si5351_t* pHandle, si5351_channel_e eChannel, si5351_pll_e ePllSrc, si5351_multisynth_div_e eDivider)
{
 ...
 */
err_t SI5351_SetupRdiv(i2c_si5351_t* pHandle, si5351_channel_e eChannel, si5351_r_div_e eDivider)
{
 ...
 */
err_t SI5351_SetupMultisynth(i2c_si5351_t* pHandle, si5351_channel_e eChannel, si5351_pll_e ePllSrc, uint32_t u32Divider, uint32_t u32Numerator, uint32_t u32Denominator)
{
 ...
 */
err_t SI5351_EnableOutputs(i2c_si5351_t* pHandle, bool bEnabled)
{
    /* Enabled desired outputs (see Register 3) */
...
err_t SI5351_EnableSpreadSpectrum(i2c_si5351_t* pHandle, bool bEnabled)
{
    uint8_t u8Data;
