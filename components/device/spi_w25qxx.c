...
#define W25QXX_TIMEOUT_VALUE            1000  // ms
...
static inline err_t _W25Qxx_Reset(spi_w25qxx_t* pHandle);
static inline err_t _W25Qxx_GetStatus(spi_w25qxx_t* pHandle);
static inline err_t _W25Qxx_WriteEnable(spi_w25qxx_t* pHandle);
static inline err_t _W25Qxx_WriteDisable(spi_w25qxx_t* pHandle);
static inline err_t _W25Qxx_PollForIdle(spi_w25qxx_t* pHandle, uint16_t u16Timeout);
...
static inline err_t _W25Qxx_WriteAddr(spi_w25qxx_t* pHandle, uint32_t u32Address)
{
    uint8_t au8Cmd[4];
 ...
 */
err_t W25Qxx_ReadDeviceID(spi_w25qxx_t* pHandle, uint8_t ID[2])
{
 ...
 */
err_t W25Qxx_ReadUniqueID(spi_w25qxx_t* pHandle, uint8_t ID[8])
{
 ...
 */
err_t W25Qxx_WriteDataNoCheck(spi_w25qxx_t* pHandle, uint32_t u32WriteAddr, uint32_t u32Size, const uint8_t* cpu8Data)
{
